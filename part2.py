...
dnn = Sequential()
dnn.add(Dense(32, activation='relu', input_dim=123)) # input_dim is the vector length corresponding to the dataset; 
#refer to pre-processing for cacultating the vector length of different data resources. 
